...
def predict(
    ...
    for fold_idx in range(config["n_folds"]):
        ...
        s_cm = skmetrics.confusion_matrix(y_true=s_trues, y_pred=s_preds, labels=[0,1,2,3]) ##Changed
    ...
    cm = skmetrics.confusion_matrix(y_true=trues, y_pred=preds, labels=[0,1,2,3]) ##Changed
